...
**Version 1.2 — en vigueur à compter du 7 mai 2026**

La présente politique décrit la façon dont {{SITE_LEGAL_ENTITY}} ({{SITE_LEGAL_ADDRESS}}, ci-après « **l'Éditeur** ») collecte, utilise, conserve et protège vos données personnelles lorsque vous utilisez le site `https://www.la-mutuelle-seniors.fr` (« **le Site** »).
...
- **Raison sociale** : {{SITE_LEGAL_ENTITY}}
- **Adresse** : {{SITE_LEGAL_ADDRESS}}
- **Email** : {{SITE_EMAIL}}
- **Délégué à la protection des données (DPO)** : {{SITE_DPO_NAME}} — {{SITE_DPO_EMAIL}}
...
Les données collectées sont traitées et hébergées **en France**, sur des serveurs situés dans l'Union européenne. Aucun transfert hors UE n'est effectué pour les données issues du formulaire.
...
Pour exercer ces droits, contactez notre DPO **{{SITE_DPO_NAME}}** à : **{{SITE_DPO_EMAIL}}**. Une réponse vous sera apportée dans un délai d'**un mois** maximum (prolongeable de deux mois dans les cas complexes).
...
Le Site n'utilise **aucun cookie tiers** publicitaire. Aucun traceur n'est déposé avant que vous n'ayez fait un choix explicite via notre bandeau de consentement.

Notre outil de mesure d'audience (Plausible) est conçu pour **ne déposer aucun cookie**, mais nous demandons néanmoins votre consentement avant d'activer la mesure pour respecter le principe de transparence.

Vous pouvez à tout moment réviser vos préférences via le bandeau accessible en bas de page (un clic suffit pour le rouvrir).
...
**Évolutions par rapport à la version 1.1 (6 mai 2026)** :

- Identification nominative du Délégué à la protection des données (DPO) à l'article 1, à l'article 8 et à l'article 11.

## 11. Contact

Pour toute question relative à la protection de vos données, contactez notre DPO **{{SITE_DPO_NAME}}** à : **{{SITE_DPO_EMAIL}}**.
